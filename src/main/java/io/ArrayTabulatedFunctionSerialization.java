...
public class ArrayTabulatedFunctionSerialization {
    public static void main(String[] args) {
        try {
            try (BufferedOutputStream bufferedOutputStream = new BufferedOutputStream(new FileOutputStream("C:\\Users\\dmitr\\IdeaProjects\\laba2-OOP\\output\\serialized array function.bin"))) {
        ...
        try {
            try (BufferedInputStream bufferedInputStream = new BufferedInputStream(new FileInputStream("C:\\Users\\dmitr\\IdeaProjects\\laba2-OOP\\output\\serialized array function.bin"))) {
